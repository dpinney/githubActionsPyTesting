...
if platform.system()=="Windows":
	os.system("choco install --no-progress -y wget")
	os.system("wget -nv --no-check-certificate https://github.com/CristiFati/Prebuilt-Binaries/raw/master/PyGraphviz/v1.5/Graphviz-2.42.2/pygraphviz-1.5-cp37-cp37m-win_amd64.whl")
